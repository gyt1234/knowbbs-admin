<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="请输入父板块名称" v-model="query" clearable @clear="getFatherList">
            <el-button slot="append" icon="el-icon-search" @click="queryFather"></el-button>
          </el-input>
        </el-col>
        <el-col :span="4">
        ...
        <el-table-column label="操作" width="180px">
          <template slot-scope='scope'>
            ...
            <el-tooltip effect="dark" content="删除" placement="top" :enterable="false">
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteFatherById(scope.row.id)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    // 根据名称搜索特定父板块
    async queryFather() {
      const { data: res } = await this.$http.get('/father_query.php', { params: { module_name: this.query } })
      this.fatherList = res
    },
    // 新增父板块弹窗
    addDialog() {
